...
if __name__ == '__main__':
    ...
    grp_head = tkinter.Label(app, text="Made by: Group 7\n\rGokhale Education Society's \nR.H. Sapat College Of Engineering, Management Studies and Research, Nashik", font=("DUBIELPLAIN", 21, "bold"))
